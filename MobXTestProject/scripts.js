...
// Если пользователь не находится на главном экране, то нужно показать кнопку назад.
if (window.location.href != "https://new.faberlic.com/") {
